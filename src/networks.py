...
__all__ = ['TransferLearningModel', 'SnapMixTransferLearningModelBasic', 'SnapMixTransferLearningModel']
...
class SnapMixTransferLearningModelBasic(nn.Module):
    ...
    def __init__(self, encoder:nn.Module, c:int, cut:int=-2, **kwargs):
        ...
        Args:
            ...
            cut: number of layers to cut/keep from the encoder
        """
        super(SnapMixTransferLearningModelBasic, self).__init__()

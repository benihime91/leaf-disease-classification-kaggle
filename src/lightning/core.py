...
__all__ = ['params', 'CassavaLightningDataModule', 'LightningCassava', 'example_conf']
...
class LightningCassava(pl.LightningModule):
    ...
    def __init__(self, model: Union[TransferLearningModel, SnapMixTransferLearningModel, SnapMixTransferLearningModelBasic],
                 conf: dict):
